...
B(\boldsymbol{x},t)}f(\boldsymbol{y})dS=r^2\int_{\partial B(\boldsymbol{0},1)}
f(\boldsymbol{x}+t\boldsymbol{z})dS(\boldsymbol{z})$. Looking at the average
notation, then for sufficiently smooth function, $f$, we have
$\dashint_{\partial B(\boldsymbol{x}, t)} f(\boldsymbol{y})dS(\boldsymbol{y}) =
\dashint_{\partial B(\boldsymbol{0}, 1)}
...
\begin{equation*}
    ...
    &=\dashint_{\partial B(\boldsymbol{x},t)} {g(\boldsymbol{y})dS(\boldsymbol{y})}+t \dashint_{\partial B(\boldsymbol{x},t)}{Dg(\boldsymbol{y})\Big(\frac{\boldsymbol{y}-\boldsymbol{x}}{t}\Big)dS(\boldsymbol{y})}\\
...
\begin{equation} \label{h=0} 
    \begin{aligned}
        ...
        &=\frac{1}{c^2}\dashint_{\partial B(\boldsymbol{0}, 1)}g(\boldsymbol{x}+t\boldsymbol{z})dS(\boldsymbol{z})+\frac{1}{c^2}t\diffp[1]{}{t}\dashint_{\partial B(\boldsymbol{0}, 1)}g(\boldsymbol{x}+t\boldsymbol{z})dS(\boldsymbol{z})\\
        &=\frac{1}{c^2}\dashint_{\partial B(\boldsymbol{0}, 1)}g(\boldsymbol{x}+t\boldsymbol{z})dS(\boldsymbol{z})+\frac{1}{c^2}t^2\dashint_{\partial B(\boldsymbol{0}, 1)}Dg(\boldsymbol{x}+t\boldsymbol{z}) \cdot \boldsymbol{z}dS(\boldsymbol{z})\\
        &=\frac{1}{c^2}\dashint_{\partial B(\boldsymbol{x}, t)}g(\boldsymbol{y})dS(\boldsymbol{y})+\frac{1}{c^2}t^2dashint_{\partial B(\boldsymbol{x}, t)}Dg(\boldsymbol{y})\Big(\frac{\boldsymbol{y}-\boldsymbol{x}}{t}\Big)dS(\boldsymbol{y})\\
...
\begin{equation}  \label{triangle}
    u(\boldsymbol{x},t)=\diffp[1]{}{t}\Big( 2t^2\dashint_{B(\boldsymbol{x},t)}\frac{cg(\boldsymbol{y})}{(c^2 t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}\Big) + 2t^2 \dashint_{B(\boldsymbol{x},t)} \frac{h(\boldsymbol{y})}{(c^2 t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}.
\end{equation} 

Consider $t^2\dashint_{B(\boldsymbol{x},t)}\frac{cg(\boldsymbol{y})}
{(c^2t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}$ and let
$\boldsymbol{y} = \boldsymbol{x}+t\boldsymbol{z}$. Then 
\begin{equation*}
    \begin{aligned}
        t^2\dashint_{B(\boldsymbol{x},t)}\frac{cg(\boldsymbol{y})}{(c^2t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}&=t^2\dashint_{B(\boldsymbol{0},1)}\frac{cg(\boldsymbol{x}+t\boldsymbol{z})}{(c^2t^2-|t\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z}\\ 
        &=t^2\dashint_{B(\boldsymbol{0},1)}\frac{cg(\boldsymbol{x}+t\boldsymbol{z})}{t(c^2-|\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z}\\ 
        &=t\dashint_{B(\boldsymbol{0},1)}\frac{cg(\boldsymbol{x}+t\boldsymbol{z})}{(c^2-|\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z}.
    \end{aligned}
\end{equation*}
...
\begin{equation*}
    \begin{aligned}
        \diffp[1]{}{t}\Big(2t^2\dashint_{B(\boldsymbol{x},t)}\frac{cg(\boldsymbol{y})}{(c^2 t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}\Big)&=\diffp[1]{}{t}\Big(2t\dashint_{B(\boldsymbol{0},1)}\frac{cg(\boldsymbol{x}+t\boldsymbol{z})}{(c^2-|\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z}\Big)\\ 
        &=2\dashint_{B(\boldsymbol{0},1)}\frac{cg(\boldsymbol{x}+t\boldsymbol{z})}{(c^2-|\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z} + 2t\dashint_{B(\boldsymbol{0},1)}\frac{cDg(\boldsymbol{x}+t\boldsymbol{z})\boldsymbol{z}}{(c^2-|\boldsymbol{z}|^2)^{1/2}}d\boldsymbol{z}\\ 
        &=2t\dashint_{B(\boldsymbol{x},t)}\frac{cg(\boldsymbol{y})}{(c^2t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}\\
        &+2t\dashint_{B(\boldsymbol{x},t)}\frac{cDg(\boldsymbol{y})(\boldsymbol{y}-\boldsymbol{x})}{(c^2t^2-|\boldsymbol{y}-\boldsymbol{x}|^2)^{1/2}}d\boldsymbol{y}. 
    \end{aligned}
\end{equation*}
...
\end{equation} 
 ...
 t(t^2-|\boldsymbol{y} -\boldsymbol{x}|^2)^{-1/2}$, and substituting this into the
