...
\end{equation} 
 ...
 $\alpha(n)=\frac{\pi^{\frac{n}{2}}}{\Gamma(\frac{n+2}{2})}$, where $\Gamma (n)=
 \int_0^{\infty} e^{-x} x^{n-1} dx$ is the Gamma function, and consider
 ...
 as in even dimensions, sphere do not make sense. As in the two-dimensional
